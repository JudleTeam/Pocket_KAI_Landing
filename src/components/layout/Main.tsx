...
export function Main() {
  return (
    <main className="flex flex-1 justify-between items-center container">
      <div className="flex flex-col items-center gap-10">
        ...
        <p className="text-2xl text-white">Делай больше. Будь лучше.</p>
      ...
      <div className="h-[800px] min-w-[400px] transition-all duration-500 translate-x-28 hover:translate-x-20 hover:-rotate-12">
